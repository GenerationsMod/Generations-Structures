package generations.gg.generations.structures.generationsstructures.processors.structure_processors.shrines.lunarDuo;
...
public class LunarDuoShrineRandomizerProcessor extends StructureProcessor {

    public static final LunarDuoShrineRandomizerProcessor INSTANCE = new LunarDuoShrineRandomizerProcessor();
    public static final Codec<LunarDuoShrineRandomizerProcessor> CODEC = Codec.unit(() -> INSTANCE);
    ...
    protected @NotNull StructureProcessorType<?> getType() {
        return StructureProcessors.LUNAR_DUO_SHRINE_RANDOMIZER_PROCESSOR;
    }
}
