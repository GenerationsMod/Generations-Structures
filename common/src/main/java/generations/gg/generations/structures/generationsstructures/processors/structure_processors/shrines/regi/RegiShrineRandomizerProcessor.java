package generations.gg.generations.structures.generationsstructures.processors.structure_processors.shrines.regi;
...
public class RegiShrineRandomizerProcessor extends StructureProcessor {

    public static final RegiShrineRandomizerProcessor INSTANCE = new RegiShrineRandomizerProcessor();
    public static final Codec<RegiShrineRandomizerProcessor> CODEC = Codec.unit(() -> INSTANCE);
    ...
    protected @NotNull StructureProcessorType<?> getType() {
        return StructureProcessors.REGI_SHRINE_RANDOMIZER_PROCESSOR;
    }
}
