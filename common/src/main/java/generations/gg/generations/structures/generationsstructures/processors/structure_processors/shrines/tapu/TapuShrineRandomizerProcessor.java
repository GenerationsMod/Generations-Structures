package generations.gg.generations.structures.generationsstructures.processors.structure_processors.shrines.tapu;
...
public class TapuShrineRandomizerProcessor extends StructureProcessor {

    public static final TapuShrineRandomizerProcessor INSTANCE = new TapuShrineRandomizerProcessor();
    public static final Codec<TapuShrineRandomizerProcessor> CODEC = Codec.unit(() -> INSTANCE);
    ...
    protected @NotNull StructureProcessorType<?> getType() {
        return StructureProcessors.TAPU_SHRINE_RANDOMIZER_PROCESSOR;
    }
}
